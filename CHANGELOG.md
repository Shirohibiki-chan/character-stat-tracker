...
### Fixes
- **Body font not loading:** Quicksand (the intended body font) was missing from the Google Fonts import, causing the entire app to fall back to system-ui (Segoe UI on Windows). All UI text now renders in Quicksand as intended.
