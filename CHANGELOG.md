...
### Fixes
- **Compare 1v1 — chart constrained to narrow width:** the growth chart was inside the max-width wrapper and rendering at 576px instead of full width. Chart now breaks out to the full section width.
