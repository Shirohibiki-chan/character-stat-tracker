...
### Fixes
- **Compare Overview and 1v1 — excessive spacing:** stat rows were too tall and padded, making both views feel empty. Row padding reduced to `py-1.5`/`py-1`, fonts reduced to `text-sm`, horizontal padding and section gaps tightened across both sub-views.
